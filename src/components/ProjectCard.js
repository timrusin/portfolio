...
const openModal = () => setModal(true)
  ...
  return (
    <div className="p-card-bg">
      ...
      <div className={modal ? 'modal-button' : 'modal-hidden'} onClick={closeModal}>CLOSE</div>
      ...
      <div className={!modal ? 'modal-button' : 'modal-hidden'} onClick={openModal}>MORE INFO</div>
