const ProjectData = [
    ...
    {
        title: "Selena's Bus",
        description: "Selena's Bus is a children's learning game that I created for my daughter, and was my capstone project while attending General Assembly. We had to implement a technology into the project that we didn't learn in class together, so I decided to build a mobile app with React Native. I also felt I struggled a bit with React.js in general on previous projects so I took this on to push myself even harder. I learned a lot from it. The app is not currently deployed anywhere, but feel free to check out the source code and even clone it down and run it if you have the ability to do so.",
